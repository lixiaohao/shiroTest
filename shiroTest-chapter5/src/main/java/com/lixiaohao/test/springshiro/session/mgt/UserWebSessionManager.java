package com.lixiaohao.test.springshiro.session.mgt;
 ...
 * @description:
 * @author: xiaohao.li
 * @create: 2018-07-26 22:47
 **/

public class UserWebSessionManager  extends DefaultWebSessionManager {
    private static final Logger log = LoggerFactory.getLogger(UserWebSessionManager.class);

    private final String DEFAULT_SESSION_ID="shiro_test";

    private Cookie sessionIdCookie;
    private boolean sessionIdCookieEnabled;

    public UserWebSessionManager() {
        Cookie cookie = new SimpleCookie(DEFAULT_SESSION_ID);
